...
* Full list can be found in [Google Scholar](https://scholar.google.com/citations?user=lJHbpY0AAAAJ)
...
* **[ECCV 2022]** **Bowen Shi**, Dongsheng Jiang, Xiaopeng Zhang, Han Li, Wenrui Dai, Junni Zou, Hongkai Xiong, Qi Tian,“A Transformer-based Decoder for Semantic Segmentation with Multi-level Context Mining”, *European Conference on Computer Vision*, Tel-Aviv, Isreal, Oct. 2022.
